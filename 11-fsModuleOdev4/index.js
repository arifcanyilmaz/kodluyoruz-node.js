...
fs.writeFile('11-fsModuleOdev4/employees.json', '{"name": "Employee 1 Arif", "salary": 4000}', (err) => {
...
fs.readFile('11-fsModuleOdev4/employees.json', 'utf8', (err, data) => {
    ...
    fs.writeFile('11-fsModuleOdev4/employees.json', JSON.stringify(employee), (err) => {
        if (err) console.log('3.Adım: Dosya Güncellenemedi.')
            ...
            fs.unlink('11-fsModuleOdev4/employees.json', (err) => {
